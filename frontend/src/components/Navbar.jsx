...
/*
 -------------------------------------------------------
| 🖼️ PhotoVault | Features | About | Login | Sign Up |
 -------------------------------------------------------
*/
    ...
    return (
        <div className='flex bg-primary-500 font-mono items-center px-5 py-3 justify-between'>
            <div className='flex items-center text-3xl'>
                <svg className='cursor-pointer ml-10' xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48">
            ...
            {token ?
                ...
                <div className='flex items-center gap-2 cursor-pointer group relative'>
                    <img className='w-10 h-10 rounded-full ' src="/src/assets/profile.jpg" alt="" />
                ...
                <div className='flex gap-5 pr-10'>
                    <button className='cursor-pointer border-0 rounded-full shadow shadow-gray-500 py-1 px-5 bg-white hover:-translate-y-1' onClick={() => navigate("/login")}>Log in</button>
                    <button className='cursor-pointer border-0 rounded-full shadow shadow-gray-500 py-1 px-5 bg-white hover:-translate-y-1' onClick={() => navigate("/register")}>Register</button>
                </div>}
        </div>
    )
}
