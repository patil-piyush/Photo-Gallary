...
const Footer = () => {
  ...
  return (
    <div className='px-6 py-10'>
      ...
      <hr className='w-3/4 mx-auto' data-aos="fade-up" />
      ...
      <div className='flex flex-col md:flex-row justify-around mt-5'>
        ...
        {/* Right: Columns */}
        <div className='grid grid-cols-2 sm:grid-cols-4 gap-8 text-center md:text-left' data-aos="fade-left">
          <div>
      ...
      {/* Footer Bottom */}
      <div className='text-center mt-10 text-sm text-gray-600' data-aos="fade-up">
